...
func TestProcessBatch_EmptyLeads(t *testing.T) {
	err := processBatch(context.Background(), nil, 10, 5, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
...
func TestProcessBatch_EmptyLeadsSlice(t *testing.T) {
	err := processBatch(context.Background(), []notionapi.Page{}, 10, 5, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		t.Fatal("enrichFunc should not be called for empty leads")
		return nil, nil
	})
	require.NoError(t, err)
...
func TestProcessBatch_AllSucceed(t *testing.T) {
	...
	err := processBatch(context.Background(), leads, 0, 2, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		count.Add(1)
...
func TestProcessBatch_AppliesLimit(t *testing.T) {
	...
	err := processBatch(context.Background(), leads, 3, 2, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		count.Add(1)
...
func TestProcessBatch_LimitLargerThanLeads(t *testing.T) {
	...
	err := processBatch(context.Background(), leads, 10, 2, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		count.Add(1)
...
func TestProcessBatch_ZeroLimit(t *testing.T) {
	...
	err := processBatch(context.Background(), leads, 0, 5, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		count.Add(1)
		return &model.EnrichmentResult{Score: 0.9}, nil
	})
	require.NoError(t, err)
...
func TestProcessBatch_Concurrency1(t *testing.T) {
	...
	err := processBatch(context.Background(), leads, 0, 1, func(_ context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		count.Add(1)
...
func TestProcessBatch_CancelledContext(t *testing.T) {
	...
	err := processBatch(ctx, leads, 0, 2, func(ctx context.Context, _ model.Company) (*model.EnrichmentResult, error) {
		if ctx.Err() != nil {
			return nil, ctx.Err()
		}
