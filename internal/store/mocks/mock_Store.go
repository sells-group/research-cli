...
// MockStore_DeleteCheckpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteCheckpoint'
type MockStore_DeleteCheckpoint_Call struct {
	*mock.Call
}

// DeleteCheckpoint is a helper method to define mock.On call
//   - ctx context.Context
//   - companyID string
func (_e *MockStore_Expecter) DeleteCheckpoint(ctx interface{}, companyID interface{}) *MockStore_DeleteCheckpoint_Call {
	return &MockStore_DeleteCheckpoint_Call{Call: _e.mock.On("DeleteCheckpoint", ctx, companyID)}
}

func (_c *MockStore_DeleteCheckpoint_Call) Run(run func(ctx context.Context, companyID string)) *MockStore_DeleteCheckpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStore_DeleteCheckpoint_Call) Return(_a0 error) *MockStore_DeleteCheckpoint_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_DeleteCheckpoint_Call) RunAndReturn(run func(context.Context, string) error) *MockStore_DeleteCheckpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_DeleteExpiredLinkedIn_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteExpiredLinkedIn'
type MockStore_DeleteExpiredLinkedIn_Call struct {
	*mock.Call
}

// DeleteExpiredLinkedIn is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockStore_Expecter) DeleteExpiredLinkedIn(ctx interface{}) *MockStore_DeleteExpiredLinkedIn_Call {
	return &MockStore_DeleteExpiredLinkedIn_Call{Call: _e.mock.On("DeleteExpiredLinkedIn", ctx)}
}

func (_c *MockStore_DeleteExpiredLinkedIn_Call) Run(run func(ctx context.Context)) *MockStore_DeleteExpiredLinkedIn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockStore_DeleteExpiredLinkedIn_Call) Return(_a0 int, _a1 error) *MockStore_DeleteExpiredLinkedIn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_DeleteExpiredLinkedIn_Call) RunAndReturn(run func(context.Context) (int, error)) *MockStore_DeleteExpiredLinkedIn_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_DeleteExpiredScrapes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteExpiredScrapes'
type MockStore_DeleteExpiredScrapes_Call struct {
	*mock.Call
}

// DeleteExpiredScrapes is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockStore_Expecter) DeleteExpiredScrapes(ctx interface{}) *MockStore_DeleteExpiredScrapes_Call {
	return &MockStore_DeleteExpiredScrapes_Call{Call: _e.mock.On("DeleteExpiredScrapes", ctx)}
}

func (_c *MockStore_DeleteExpiredScrapes_Call) Run(run func(ctx context.Context)) *MockStore_DeleteExpiredScrapes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockStore_DeleteExpiredScrapes_Call) Return(_a0 int, _a1 error) *MockStore_DeleteExpiredScrapes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_DeleteExpiredScrapes_Call) RunAndReturn(run func(context.Context) (int, error)) *MockStore_DeleteExpiredScrapes_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_GetCachedScrape_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCachedScrape'
type MockStore_GetCachedScrape_Call struct {
	*mock.Call
}

// GetCachedScrape is a helper method to define mock.On call
//   - ctx context.Context
//   - urlHash string
func (_e *MockStore_Expecter) GetCachedScrape(ctx interface{}, urlHash interface{}) *MockStore_GetCachedScrape_Call {
	return &MockStore_GetCachedScrape_Call{Call: _e.mock.On("GetCachedScrape", ctx, urlHash)}
}

func (_c *MockStore_GetCachedScrape_Call) Run(run func(ctx context.Context, urlHash string)) *MockStore_GetCachedScrape_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockStore_GetCachedScrape_Call) Return(_a0 []byte, _a1 error) *MockStore_GetCachedScrape_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_GetCachedScrape_Call) RunAndReturn(run func(context.Context, string) ([]byte, error)) *MockStore_GetCachedScrape_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_GetHighConfidenceAnswers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHighConfidenceAnswers'
type MockStore_GetHighConfidenceAnswers_Call struct {
	*mock.Call
}

// GetHighConfidenceAnswers is a helper method to define mock.On call
//   - ctx context.Context
//   - companyURL string
...
func (_c *MockStore_GetHighConfidenceAnswers_Call) Return(_a0 []model.ExtractionAnswer, _a1 error) *MockStore_GetHighConfidenceAnswers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// MockStore_GetLatestProvenance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLatestProvenance'
type MockStore_GetLatestProvenance_Call struct {
	*mock.Call
}

// GetLatestProvenance is a helper method to define mock.On call
//   - ctx context.Context
//   - companyURL string
func (_e *MockStore_Expecter) GetLatestProvenance(ctx interface{}, companyURL interface{}) *MockStore_GetLatestProvenance_Call {
	return &MockStore_GetLatestProvenance_Call{Call: _e.mock.On("GetLatestProvenance", ctx, companyURL)}
}

func (_c *MockStore_GetLatestProvenance_Call) Run(run func(ctx context.Context, companyURL string)) *MockStore_GetLatestProvenance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockStore_GetLatestProvenance_Call) Return(_a0 []model.FieldProvenance, _a1 error) *MockStore_GetLatestProvenance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// MockStore_GetProvenance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetProvenance'
type MockStore_GetProvenance_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - runID string
func (_e *MockStore_Expecter) GetProvenance(ctx interface{}, runID interface{}) *MockStore_GetProvenance_Call {
	return &MockStore_GetProvenance_Call{Call: _e.mock.On("GetProvenance", ctx, runID)}
}

func (_c *MockStore_GetProvenance_Call) Run(run func(ctx context.Context, runID string)) *MockStore_GetProvenance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockStore_GetProvenance_Call) Return(_a0 []model.FieldProvenance, _a1 error) *MockStore_GetProvenance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_GetProvenance_Call) RunAndReturn(run func(context.Context, string) ([]model.FieldProvenance, error)) *MockStore_GetProvenance_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_LoadCheckpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LoadCheckpoint'
type MockStore_LoadCheckpoint_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - companyID string
func (_e *MockStore_Expecter) LoadCheckpoint(ctx interface{}, companyID interface{}) *MockStore_LoadCheckpoint_Call {
	return &MockStore_LoadCheckpoint_Call{Call: _e.mock.On("LoadCheckpoint", ctx, companyID)}
}

func (_c *MockStore_LoadCheckpoint_Call) Run(run func(ctx context.Context, companyID string)) *MockStore_LoadCheckpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockStore_LoadCheckpoint_Call) Return(_a0 *model.Checkpoint, _a1 error) *MockStore_LoadCheckpoint_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_LoadCheckpoint_Call) RunAndReturn(run func(context.Context, string) (*model.Checkpoint, error)) *MockStore_LoadCheckpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_SaveCheckpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveCheckpoint'
type MockStore_SaveCheckpoint_Call struct {
	*mock.Call
}
...
//   - phase string
//   - data []byte
func (_e *MockStore_Expecter) SaveCheckpoint(ctx interface{}, companyID interface{}, phase interface{}, data interface{}) *MockStore_SaveCheckpoint_Call {
	return &MockStore_SaveCheckpoint_Call{Call: _e.mock.On("SaveCheckpoint", ctx, companyID, phase, data)}
}

func (_c *MockStore_SaveCheckpoint_Call) Run(run func(ctx context.Context, companyID string, phase string, data []byte)) *MockStore_SaveCheckpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStore_SaveCheckpoint_Call) Return(_a0 error) *MockStore_SaveCheckpoint_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_SaveCheckpoint_Call) RunAndReturn(run func(context.Context, string, string, []byte) error) *MockStore_SaveCheckpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_SaveProvenance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveProvenance'
type MockStore_SaveProvenance_Call struct {
	*mock.Call
}

// SaveProvenance is a helper method to define mock.On call
//   - ctx context.Context
//   - records []model.FieldProvenance
func (_e *MockStore_Expecter) SaveProvenance(ctx interface{}, records interface{}) *MockStore_SaveProvenance_Call {
	return &MockStore_SaveProvenance_Call{Call: _e.mock.On("SaveProvenance", ctx, records)}
}

func (_c *MockStore_SaveProvenance_Call) Run(run func(ctx context.Context, records []model.FieldProvenance)) *MockStore_SaveProvenance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]model.FieldProvenance))
	})
	return _c
}

func (_c *MockStore_SaveProvenance_Call) Return(_a0 error) *MockStore_SaveProvenance_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_SaveProvenance_Call) RunAndReturn(run func(context.Context, []model.FieldProvenance) error) *MockStore_SaveProvenance_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStore_SetCachedScrape_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetCachedScrape'
type MockStore_SetCachedScrape_Call struct {
	*mock.Call
}

// SetCachedScrape is a helper method to define mock.On call
//   - ctx context.Context
//   - urlHash string
//   - content []byte
//   - ttl time.Duration
func (_e *MockStore_Expecter) SetCachedScrape(ctx interface{}, urlHash interface{}, content interface{}, ttl interface{}) *MockStore_SetCachedScrape_Call {
	return &MockStore_SetCachedScrape_Call{Call: _e.mock.On("SetCachedScrape", ctx, urlHash, content, ttl)}
}

func (_c *MockStore_SetCachedScrape_Call) Run(run func(ctx context.Context, urlHash string, content []byte, ttl time.Duration)) *MockStore_SetCachedScrape_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].([]byte), args[3].(time.Duration))
	})
	return _c
...
func (_c *MockStore_SetCachedScrape_Call) Return(_a0 error) *MockStore_SetCachedScrape_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_SetCachedScrape_Call) RunAndReturn(run func(context.Context, string, []byte, time.Duration) error) *MockStore_SetCachedScrape_Call {
	_c.Call.Return(run)
	return _c
}
