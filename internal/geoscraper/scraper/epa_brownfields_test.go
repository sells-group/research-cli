...
func TestBrownfields_Metadata(t *testing.T) {
	s := &EPABrownfields{}
	assert.Equal(t, "epa_brownfields", s.Name())
...
func TestBrownfields_ShouldRun(t *testing.T) {
	s := &EPABrownfields{}
	now := fixedNow()
...
func TestBrownfields_Sync(t *testing.T) {
	data, err := os.ReadFile("testdata/brownfields.json")
...
func TestBrownfields_UpsertError(t *testing.T) {
	data, err := os.ReadFile("testdata/brownfields.json")
	require.NoError(t, err)
