...
func TestDownloadFOIAZIP_Error(t *testing.T) {
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), "temporal: download ZIP")
...
func TestProcessPDFViaDocling_ReadFailure(t *testing.T) {
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), "temporal: read PDF")
}
...
func TestProcessPDFViaDocling_ConvertFailure(t *testing.T) {
	...
	_, err := act.ProcessPDFViaDocling(context.Background(), params)
	require.Error(t, err)
	require.Contains(t, err.Error(), "temporal: docling convert")
...
func TestUpsertDocumentBatch_Error(t *testing.T) {
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), "temporal: upsert documents")
	require.NoError(t, mock.ExpectationsWereMet())
}
...
func TestUpsertSectionBatch_Error(t *testing.T) {
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), "temporal: upsert sections")
	require.NoError(t, mock.ExpectationsWereMet())
}
