-- 077: Enrich mv_pe_intelligence with deep ADV aggregates
-- Drops and recreates the materialized view to add:
--   Scale & financials (accounts, employees, revenue, margin)
--   Growth trends (1yr, 3yr AUM CAGR)
--   Regulatory & risk scores (DRPs, regulatory risk, concentration, key person)
--   Service profile (discretionary %, common services/compensation)
--   Top RIAs by AUM (JSONB array)
