-- 079: Add geography + new answer columns to mv_pe_intelligence
-- Drops and recreates the materialized view to add:
--   Geographic concentration (state count, top state, top state AUM %)
--   New PE answer columns (acquisitions, deal velocity, integration, dry powder, etc.)
